...
/**
 * Factory for creating CUVS (CUDA Vector Search) index providers.
 * This factory creates CUVS index providers that use GPU-accelerated
...
public class CuvsIndexProviderFactory extends AbstractIndexProviderFactory<org.neo4j.kernel.api.index.IndexProvider> {
    ...
    @Override
    protected org.neo4j.kernel.api.index.IndexProvider internalCreate(
            PageCache pageCache,
